...
@register_object("meta_schedule.MySearch")
class MySearch(SearchStrategy):
    ...
    def __init__(
        ...
        *,
        ...
        init_measured_ratio: float = 0.8,
        init_min_unmeasured: int = 10,
        max_fail_count: int = 5,
        genetic_num_iters: int = 4,
        genetic_mutate_prob: float = 1,
        genetic_max_fail_count: int = 10,
        eps_greedy: float = 0.05,
    ) -> None:
        """Constructor"""
        self.__init_handle_by_constructor__(
            _ffi_api.SearchStrategyMySearch,  # type: ignore # pylint: disable=no-member
            population_size,
            init_measured_ratio,
            init_min_unmeasured,
            max_fail_count,
